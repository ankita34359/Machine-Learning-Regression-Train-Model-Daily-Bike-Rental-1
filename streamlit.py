...
bike_rental_model_pkl = r'C:\Users\Lenovo\OneDrive\Desktop\Juypter_projects\bike_rental_model.pkl'
loaded_model = joblib.load(bike_rental_model_pkl)

st.header("Bike Rental Application")
